...
<div style="padding: 20px;">
    <div style="background: white; border-radius: 8px; padding: 20px;">
        <h1>📤 Importar Equipos desde Excel</h1>
        ...
        <form method="POST" action="{{ route("equipments.import") }}" enctype="multipart/form-data">
            ...
            <div style="margin-bottom: 15px;">
                ...
                <p style="font-size: 12px; color: #666;">Columnas esperadas: codigo, nombre, categoria, unidad, precio, termino, descripcion</p>
            </div>
...
@endsection' > resources\views\equipments\import.blade.php