<div style="display: flex; align-items: center; gap: 20px;">
    ...
    <a href="{{ route('transports.index') }}" style="color: #4b5563; text-decoration: none;">🚚 Transporte</a>
    <span style="color: #ccc;">|</span>
    ...
    <a href="{{ route('budgets.create-with-milestones') }}" style="color: #22c55e; text-decoration: none;">🚀 Nuevo Presupuesto con Hitos</a>
    <span style="color: #ccc;">|</span>
    <!-- Menú de usuario -->
