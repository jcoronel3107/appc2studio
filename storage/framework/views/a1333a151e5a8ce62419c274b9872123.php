...
<div style="padding: 20px;">
    <div style="background: white; border-radius: 8px; padding: 20px;">
        ...
        <form method="POST" action="<?php echo e(route('budgets.store-chapter')); ?>" id="budgetForm">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\desarrollo\appc2studio_\resources\views/budgets/create_chapter.blade.php ENDPATH**/ ?>