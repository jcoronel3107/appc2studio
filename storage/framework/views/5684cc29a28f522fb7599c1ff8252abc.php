...
<html>
<head>
    <title>Editar APU - <?php echo e($apu->code); ?></title>
    <style>
...
<body>
    <div class="container">
        <h1>✏️ Editar APU: <?php echo e($apu->code); ?></h1>
        
        <form method="POST" action="/apu/<?php echo e($apu->id); ?>" id="editForm">
            <?php echo csrf_field(); ?>
            <?php echo method_field("PUT"); ?>
            
            <div class="form-group">
                <label>Código:</label>
                <input type="text" name="code" value="<?php echo e($apu->code); ?>" required>
            </div>
            
            <div class="form-group">
                <label>Rubro:</label>
                <input type="text" name="name" value="<?php echo e($apu->name); ?>" required>
            </div>
            
            <div class="form-group">
                <label>Unidad:</label>
                <input type="text" name="unit" value="<?php echo e($apu->unit); ?>" required>
            </div>
            ...
            <div class="section">
                ...
                <table id="tabla-equipos">
                    ...
                    <tbody>
                        ...
                        <tr class="item-row" data-section="equipment" data-id="<?php echo e($item->id); ?>">
                            <td><input type="text" name="items[<?php echo e($item->id); ?>][description]" value="<?php echo e($item->description); ?>"></td>
                            <td><input type="number" step="0.01" name="items[<?php echo e($item->id); ?>][quantity]" value="<?php echo e($item->quantity); ?>" class="quantity" data-id="<?php echo e($item->id); ?>"></td>
                            <td><input type="number" step="0.01" name="items[<?php echo e($item->id); ?>][unit_price]" value="<?php echo e($item->unit_price); ?>" class="price" data-id="<?php echo e($item->id); ?>"></td>
                            <td><input type="number" step="0.01" name="items[<?php echo e($item->id); ?>][performance]" value="<?php echo e($item->performance); ?>"></td>
                            <td><span class="total-<?php echo e($item->id); ?>"><?php echo e(number_format($item->total, 2)); ?></span></td>
                        </tr>
            ...
            <div class="section">
                ...
                <table id="tabla-labor">
                    ...
                    <tbody>
                        ...
                        <tr class="item-row" data-section="labor" data-id="<?php echo e($item->id); ?>">
                            <td><input type="text" name="items[<?php echo e($item->id); ?>][description]" value="<?php echo e($item->description); ?>"></td>
                            <td><input type="number" step="0.01" name="items[<?php echo e($item->id); ?>][quantity]" value="<?php echo e($item->quantity); ?>" class="quantity" data-id="<?php echo e($item->id); ?>"></td>
                            <td><input type="number" step="0.01" name="items[<?php echo e($item->id); ?>][unit_price]" value="<?php echo e($item->unit_price); ?>" class="price" data-id="<?php echo e($item->id); ?>"></td>
                            <td><input type="number" step="0.01" name="items[<?php echo e($item->id); ?>][performance]" value="<?php echo e($item->performance); ?>"></td>
            ...
            <div class="section">
                ...
                <table id="tabla-materiales">
                    ...
                    <tbody>
                        ...
                        <tr class="item-row" data-section="material" data-id="<?php echo e($item->id); ?>">
                            <td><input type="text" name="items[<?php echo e($item->id); ?>][description]" value="<?php echo e($item->description); ?>"></td>
                            <td><input type="number" step="0.01" name="items[<?php echo e($item->id); ?>][quantity]" value="<?php echo e($item->quantity); ?>" class="quantity" data-id="<?php echo e($item->id); ?>"></td>
                            <td><input type="number" step="0.01" name="items[<?php echo e($item->id); ?>][unit_price]" value="<?php echo e($item->unit_price); ?>" class="price" data-id="<?php echo e($item->id); ?>"></td>
                            <td><span class="total-<?php echo e($item->id); ?>"><?php echo e(number_format($item->total, 2)); ?></span></td>
            ...
            <div class="section">
                ...
                <table id="tabla-transporte">
                    ...
                    <tbody>
                        ...
                        <tr class="item-row" data-section="transport" data-id="<?php echo e($item->id); ?>">
                            <td><input type="text" name="items[<?php echo e($item->id); ?>][description]" value="<?php echo e($item->description); ?>"></td>
                            <td><input type="number" step="0.01" name="items[<?php echo e($item->id); ?>][quantity]" value="<?php echo e($item->quantity); ?>" class="quantity" data-id="<?php echo e($item->id); ?>"></td>
                            <td><input type="number" step="0.01" name="items[<?php echo e($item->id); ?>][unit_price]" value="<?php echo e($item->unit_price); ?>" class="price" data-id="<?php echo e($item->id); ?>"></td>
                            <td><span class="total-<?php echo e($item->id); ?>"><?php echo e(number_format($item->total, 2)); ?></span></td>
            ...
            <a href="/apu/<?php echo e($apu->id); ?>" class="btn btn-cancel">Cancelar</a>
        </form>
    </div>
...
</html>' > resources\views\apus\edit.blade.php<?php /**PATH D:\desarrollo\appc2studio\appc2studio\resources\views/apus/edit.blade.php ENDPATH**/ ?>