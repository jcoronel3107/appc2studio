...
<div style="padding: 20px;">
    <div style="background: white; border-radius: 8px; padding: 20px;">
        <h1>✏️ Editar APU: <?php echo e($apu->code); ?> - <?php echo e($apu->name); ?></h1>
        
        <form method="POST" action="<?php echo e(route('apus.update', $apu->id)); ?>" id="apuForm" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div style="background: #f0f0f0; padding: 15px; margin-bottom: 20px; border-radius: 5px;">
                ...
                <div style="margin-bottom: 10px;">
                    <label>Código:</label>
                    <input type="text" name="code" value="<?php echo e($apu->code); ?>" required style="width:100%; padding: 8px;">
                </div>
                <div style="margin-bottom: 10px;">
                    <label>Rubro:</label>
                    <input type="text" name="name" value="<?php echo e($apu->name); ?>" required style="width:100%; padding: 8px;">
                </div>
                <div style="margin-bottom: 10px;">
                    <label>Unidad:</label>
                    <input type="text" name="unit" value="<?php echo e($apu->unit); ?>" required style="width:100%; padding: 8px;">
                </div>
                <div style="margin-bottom: 10px;">
                    <label>📄 Archivo Word (Opcional):</label>
                    <?php if($apu->word_file): ?>
                        <div style="margin-bottom: 5px;">
                            <a href="<?php echo e(Storage::url($apu->word_file)); ?>" target="_blank">📄 Ver archivo actual</a>
                        </div>
                    <?php endif; ?>
            ...
            <div style="margin-bottom: 30px;">
                ...
                <div id="equipos-container">
                    <?php $equiposItems = $apu->items->where('section', 'equipment'); ?>
                    <?php if($equiposItems->count() > 0): ?>
                        ...
                        <div class="equipo-row" style="margin-bottom: 10px; display: flex; gap: 10px; flex-wrap: wrap; align-items: center;">
                            <select name="equipos[<?php echo e($index); ?>][material_id]" style="flex: 2; padding: 8px;" class="equipo-select select2">
                            ...
                            <input type="text" name="equipos[<?php echo e($index); ?>][unit]" placeholder="📏 Unidad" style="flex: 1; padding: 8px;" class="equipo-unidad" readonly value="<?php echo e($item->unit_price ? $item->unit_price : ''); ?>">
            ...
            <div style="margin-bottom: 30px;">
                ...
                <div id="labors-container">
                    <?php $laborsItems = $apu->items->where('section', 'labor'); ?>
                    <?php if($laborsItems->count() > 0): ?>
                        ...
                        <div class="labor-row" style="margin-bottom: 10px; display: flex; gap: 10px; flex-wrap: wrap; align-items: center;">
                            <select name="labors[<?php echo e($index); ?>][labor_id]" style="flex: 2; padding: 8px;" class="labor-select select2">
            ...
            <div style="margin-bottom: 30px;">
                ...
                <div id="materiales-container">
                    <?php $materialesItems = $apu->items->where('section', 'material'); ?>
                    <?php if($materialesItems->count() > 0): ?>
                        ...
                        <div class="material-row" style="margin-bottom: 10px; display: flex; gap: 10px; flex-wrap: wrap; align-items: center;">
                            <select name="materiales[<?php echo e($index); ?>][material_id]" style="flex: 2; padding: 8px;" class="material-select select2">
            ...
            <div style="margin-bottom: 30px;">
                ...
                <div id="transportes-container">
                    <?php $transportesItems = $apu->items->where('section', 'transport'); ?>
                    <?php if($transportesItems->count() > 0): ?>
                        <?php $__currentLoopData = $transportesItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="transporte-row" style="margin-bottom: 10px; display: flex; gap: 10px; flex-wrap: wrap; align-items: center;">
                            <select name="transportes[<?php echo e($index); ?>][material_id]" style="flex: 2; padding: 8px;" class="transporte-select select2">
                                ...
                                <?php $__currentLoopData = $transportes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transporte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($transporte->id); ?>" data-price="<?php echo e($transporte->price); ?>" data-unit="<?php echo e($transporte->unit); ?>" <?php echo e($item->description == $transporte->name ? 'selected' : ''); ?>>
                            ...
                            <input type="number" name="transportes[<?php echo e($index); ?>][quantity]" placeholder="📊 Cantidad" step="0.01" style="flex: 1; padding: 8px;" class="transporte-cantidad" value="<?php echo e($item->quantity); ?>">
                            <input type="text" name="transportes[<?php echo e($index); ?>][unit]" placeholder="📏 Unidad" style="flex: 1; padding: 8px;" class="transporte-unidad" readonly>
                            <input type="number" name="transportes[<?php echo e($index); ?>][price]" placeholder="💰 Precio" step="0.01" style="flex: 1; padding: 8px;" class="transporte-precio" readonly value="<?php echo e($item->unit_price); ?>">
                            <input type="number" name="transportes[<?php echo e($index); ?>][performance]" placeholder="⚙️ Rendimiento" step="0.01" style="flex: 1; padding: 8px;" class="transporte-rendimiento" value="<?php echo e($item->performance ?? 1); ?>">
                            <input type="number" name="transportes[<?php echo e($index); ?>][total]" placeholder="💲 Total" step="0.01" style="flex: 1; padding: 8px; background:#e0e0e0;" class="transporte-total" readonly value="<?php echo e($item->total); ?>">
            ...
            <div style="background: #d4edda; padding: 15px; border-radius: 8px; margin-top: 20px; text-align: right;">
                ...
                <div style="display: flex; justify-content: flex-end; align-items: center; gap: 10px; margin: 10px 0;">
                    ...
                    <input type="number" id="indirectos-porcentaje" value="<?php echo e($apu->indirect_percentage ?? 20); ?>" step="0.5" min="0" max="100" style="width: 70px; padding: 5px; text-align: center;"> 
                    <p><strong>% = $ <span id="indirectos"><?php echo e(number_format($apu->indirect_cost ?? 0, 2)); ?></span></strong></p>
                </div>
                
                <hr style="margin: 10px 0;">
                <p style="font-size: 20px; font-weight: bold;"><strong>COSTO TOTAL DEL RUBRO:</strong> $ <span id="total-general"><?php echo e(number_format($apu->total_cost ?? 0, 2)); ?></span></p>
            </div>
            
            <input type="hidden" name="total_direct_cost" id="total_direct_cost" value="<?php echo e($apu->total_direct_cost ?? 0); ?>">
            <input type="hidden" name="indirect_cost" id="indirect_cost" value="<?php echo e($apu->indirect_cost ?? 0); ?>">
            <input type="hidden" name="total_cost" id="total_cost" value="<?php echo e($apu->total_cost ?? 0); ?>">
            <input type="hidden" name="indirect_percentage" id="indirect_percentage" value="<?php echo e($apu->indirect_percentage ?? 20); ?>">
            
            <div style="display: flex; gap: 15px; margin-top: 20px;">
                <button type="submit" style="background: #22c55e; color: white; padding: 10px 20px; border: none; cursor: pointer; border-radius: 4px;">💾 Guardar Cambios</button>
                <a href="<?php echo e(route('apus.index')); ?>" style="background: #6c757d; color: white; padding: 10px 20px; text-decoration: none; border-radius: 4px;">Cancelar</a>
            </div>
        </form>
    </div>
</div>
...
<script>
    ...
    function configurarEventosEquipo(row) {
        ...
        if (removeBtn) {
            removeBtn.onclick = function() { row.remove(); recalcularTotalesGenerales(); };
        }
    ...
    function configurarTodasLasFilas() {
    ...
    let transporteIndex = <?php echo e($transportesItems->count()); ?>;
    
    if (equipoIndex === 0) equipoIndex = 1;
    if (laborIndex === 0) laborIndex = 1;
    if (materialIndex === 0) materialIndex = 1;
    if (transporteIndex === 0) transporteIndex = 1;
    
    // Agregar equipo
    document.getElementById("add-equipo").onclick = function() {
    ...
    document.getElementById("add-labor").onclick = function() {
    ...
    // Agregar transporte
    document.getElementById("add-transporte").onclick = function() {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\desarrollo\appc2studio\appc2studio\resources\views/apus/edit.blade.php ENDPATH**/ ?>