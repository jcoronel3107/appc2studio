...
<body>
    <div class="container">
        ...
        <div class="totals">
            ...
            <p><strong>INDIRECTOS (<?php echo e($apu->indirect_percentage ?? 20); ?>%):</strong> $ <?php echo e(number_format($apu->indirect_cost ?? 0, 2)); ?></p>
            <p><strong>INDIRECTOS (<?php echo e($apu->indirect_percentage ?? 20); ?>%):</strong> $ <?php echo e(number_format($apu->indirect_cost ?? 0, 2)); ?></p>
            <p class="grand-total"><strong>COSTO TOTAL DEL RUBRO:</strong> $ <?php echo e(number_format($apu->total_cost ?? 0, 2)); ?></p>
            <p><strong>VALOR OFERTADO:</strong> $ <?php echo e(number_format($apu->total_cost ?? 0, 2)); ?></p>
        </div>
    </div>
</body>
