<div style="display: flex; align-items: center; gap: 20px;">
    ...
    <span style="color: #ccc;">|</span>
    <a href="<?php echo e(route('budgets.index')); ?>" style="color: #4b5563; text-decoration: none;">📋 Presupuestos</a>
    <span style="color: #ccc;">|</span>

    <a href="<?php echo e(route('budgets.create-with-milestones')); ?>" style="color: #22c55e; text-decoration: none;">🚀 Nuevo Presupuesto con Hitos</a>
    <span style="color: #ccc;">|</span>
    <!-- Menú de usuario -->
...
</div><?php /**PATH D:\desarrollo\appc2studio_\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>